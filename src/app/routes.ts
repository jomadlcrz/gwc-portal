export const ROUTES = {
  ...
  REGISTRAR_CURRICULUM_PROGRAMS: '/registrar/curriculum-facilities/programs',
  REGISTRAR_CURRICULUM_DEPARTMENTS: '/registrar/curriculum-facilities/departments',
  REGISTRAR_CURRICULUM_BUILDINGS: '/registrar/curriculum-facilities/buildings',
  REGISTRAR_CURRICULUM_ROOMS: '/registrar/curriculum-facilities/rooms',
  ...
  HR_DEAN: '/hr-portal/dean',
  HR_DEAN_MANAGE: '/hr-portal/dean/manage',
  HR_DEAN_CREATE: '/hr-portal/dean/create',
