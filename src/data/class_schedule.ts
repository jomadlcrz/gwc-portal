...
export type ScheduleEnrollmentType = 'Regular' | 'Irregular'
...
const REGULAR_ROWS: ScheduleItem[] = [
  { id: '3y2s-1', subjectCode: 'LIT2', descriptiveTitle: 'Literatures of the World', section: 'BSIT-3D', faculty: 'Mrs. Caburao', department: 'COE', room: 'Room 304', day: 'Monday', startTime: '09:00', endTime: '10:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  ...
  { id: '3y2s-5', subjectCode: 'IT312', descriptiveTitle: 'Computer Accounting (with SAP)', section: 'BSIT-3D', faculty: 'Ms. Joyce Raon', department: 'CITE', room: '305', day: 'Tuesday', startTime: '10:30', endTime: '11:30', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: '3y2s-6', subjectCode: 'PT103', descriptiveTitle: 'Platform-based Development (Android Programming)', section: 'BSIT-3D', faculty: 'Mr. Paulo Balgua', department: 'CITE', room: '303/CL2', day: 'Tuesday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  ...
  { id: '3y2s-11', subjectCode: 'PT103', descriptiveTitle: 'Platform-based Development (Android Programming)', section: 'BSIT-3D', faculty: 'Mr. Paulo Balgua', department: 'CITE', room: '303/CL2', day: 'Thursday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: '3y2s-12', subjectCode: 'CAPS101', descriptiveTitle: 'Capstone Project and Research 1', section: 'BSIT-3D', faculty: 'Mr. Willmher John Regaspi', department: 'CITE', room: '306', day: 'Thursday', startTime: '13:00', endTime: '16:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: '3y2s-14', subjectCode: 'IT312', descriptiveTitle: 'Computer Accounting (with SAP)', section: 'BSIT-3D', faculty: 'Ms. Joyce Raon', department: 'CITE', room: '305', day: 'Friday', startTime: '10:30', endTime: '11:30', deliveryMode: 'Face-to-Face', capacity: 40 },
  ...
  { id: '3y2s-18', subjectCode: 'IT312', descriptiveTitle: 'Computer Accounting (with SAP)', section: 'BSIT-3D', faculty: 'Ms. Joyce Raon', department: 'CITE', room: '305', day: 'Saturday', startTime: '10:30', endTime: '11:30', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: '3y2s-19', subjectCode: 'PT103', descriptiveTitle: 'Platform-based Development (Android Programming)', section: 'BSIT-3D', faculty: 'Mr. Paulo Balgua', department: 'CITE', room: '303/CL2', day: 'Saturday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
]
...
const IRREGULAR_ROWS: ScheduleItem[] = [
  ...
  { id: 'irr-2a', subjectCode: 'PT102', descriptiveTitle: "Platform-based Dev't (Multimedia Systems)", section: 'BSIT-3D', faculty: 'Mr. John Vianney Manuel', department: 'CITE', room: '402/CL1', day: 'Monday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: 'irr-2b', subjectCode: 'PT102', descriptiveTitle: "Platform-based Dev't (Multimedia Systems)", section: 'BSIT-3D', faculty: 'Mr. John Vianney Manuel', department: 'CITE', room: '402/CL1', day: 'Wednesday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: 'irr-2c', subjectCode: 'PT102', descriptiveTitle: "Platform-based Dev't (Multimedia Systems)", section: 'BSIT-3D', faculty: 'Mr. John Vianney Manuel', department: 'CITE', room: '402/CL1', day: 'Friday', startTime: '12:00', endTime: '14:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  ...
  { id: 'irr-6', subjectCode: 'GE ELECTIVE 4', descriptiveTitle: 'Philippine Popular Culture', section: 'BSBA-3B', faculty: 'Mr. Bryan Necessito', department: 'COE', room: '404/403', day: 'Wednesday', startTime: '09:00', endTime: '10:00', deliveryMode: 'Face-to-Face', capacity: 40 },
  { id: 'irr-7a', subjectCode: 'PATHFIT 4', descriptiveTitle: 'Group Exercise - Aerobics', section: 'BSIT-2D', faculty: 'Mr. Dether Domaoal', department: 'COE', room: 'SHS-502', day: 'Tuesday', startTime: '11:00', endTime: '12:00', deliveryMode: 'Face-to-Face', capacity: 35 },
  { id: 'irr-7b', subjectCode: 'PATHFIT 4', descriptiveTitle: 'Group Exercise - Aerobics', section: 'BSIT-2D', faculty: 'Mr. Dether Domaoal', department: 'COE', room: 'SHS-502', day: 'Thursday', startTime: '11:00', endTime: '12:00', deliveryMode: 'Face-to-Face', capacity: 35 },
]

export const CLASS_SCHEDULE_SOURCES: ClassScheduleSource[] = [
...
type ClassScheduleFilters = {
  studentId?: string
  status?: ScheduleEnrollmentType
}

function cloneRow(row: ScheduleItem): ScheduleItem {
  return { ...row }
}

export function listClassScheduleEntries(filters: ClassScheduleFilters = {}): ClassScheduleEntry[] {
  return CLASS_SCHEDULE_SOURCES
    .filter((source) => (!filters.studentId || source.studentId === filters.studentId) && (!filters.status || source.status === filters.status))
    .flatMap((source) => source.rows.map((row) => ({ studentId: source.studentId, status: source.status, row: cloneRow(row) })))
}

export function listClassScheduleRows(filters: ClassScheduleFilters = {}): ScheduleItem[] {
  return listClassScheduleEntries(filters).map((entry) => entry.row)
}

export function resolveClassScheduleRows(studentId: string, status: ScheduleEnrollmentType): ScheduleItem[] {
  return listClassScheduleRows({ studentId, status })
}

export function getScheduleUnits(row: ScheduleItem): number {
  return row.capacity >= 40 ? 3 : 2
}

export function getScheduleProgramFromSection(section: string): string {
  const code = section.split('-')[0]?.trim().toUpperCase()
  const programs: Record<string, string> = {
    BSIT: 'BS Information Technology',
    BSBA: 'BS Business Administration',
  }

  return programs[code] ?? code ?? 'General Program'
}
