...
export const INSTRUCTOR_SCHEDULES: InstructorSchedule[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { M: 'ENTREP1 - 3A', W: 'ENTREP1 - 3A' } },
      { time: '3:00 - 6:00', values: { T: 'BUSFIN1 - 3B', TH: 'BUSFIN1 - 3B' } },
    ],
  },
  {
    department: 'CBA',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { T: 'ECON1 - 2A', TH: 'ECON1 - 2A' } },
      { time: '3:00 - 6:00', values: { M: 'BUSSTAT - 2B', W: 'BUSSTAT - 2B', F: 'BUSSTAT - 2B' } },
    ],
  },
  {
    department: 'COE',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { T: 'ASSESS1 - 3B', TH: 'ASSESS1 - 3B' } },
      { time: '3:00 - 6:00', values: { W: 'CURRIC1 - 4A', F: 'CURRIC1 - 4A' } },
    ],
  },
  {
    department: 'COE',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { T: 'TEACHPRAC - 4C', TH: 'TEACHPRAC - 4C' } },
      { time: '3:00 - 6:00', values: { F: 'EDTECH - 3C' } },
    ],
  },
  {
    department: 'CCJ',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { M: 'CRIMPROC - 3A', W: 'CRIMPROC - 3A' } },
      { time: '3:00 - 6:00', values: { T: 'EVIDENCE - 3B', TH: 'EVIDENCE - 3B', S: 'EVIDENCE - 3B' } },
    ],
  },
  {
    department: 'CCJ',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { T: 'CRIMLAB - 3B', TH: 'CRIMLAB - 3B' } },
      { time: '3:00 - 6:00', values: { S: 'FORENSIC2 - 2B' } },
    ],
  },
  {
    department: 'CTE',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { M: 'CC106 - 3C', T: 'ITELEC4 - 4C', W: 'CC106 - 3C', TH: 'ITELEC4 - 4C' } },
      { time: '3:00 - 6:00', values: { M: 'CC106 - 3D', T: 'OS101 - 4A', W: 'CC106 - 3D', TH: 'OS101 - 4B', F: 'OS101 - 4D' } },
    ],
  },
  {
    department: 'CTE',
    ...
    slots: [
      ...
      { time: '12:00 - 3:00', values: { M: 'OOP - 2D', T: 'ITELEC4 - 4D', W: 'OOP - 2D', TH: 'ITELEC4 - 4D', F: 'IAS - 3E' } },
      { time: '3:00 - 6:00', values: { M: 'OOP - 2C', T: 'OOP - 2E', W: 'OOP - 2C', TH: 'OOP - 2E' } },
    ],
  },
]
